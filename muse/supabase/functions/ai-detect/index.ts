...
// ============================================================================
// System Prompt (matches packages/ai/src/prompts/entity-detector.ts)
// ============================================================================

const ENTITY_DETECTOR_SYSTEM = `You are an expert entity detector for Mythos, a creative writing IDE for fiction authors.
