...
/**
 * System prompt for consistency linting
 * Matches packages/ai/src/prompts/linter.ts
 */
const CONSISTENCY_LINTER_SYSTEM = `You are a narrative consistency analyzer for a creative writing IDE called Mythos.
