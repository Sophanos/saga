 ...
 *
 * System prompts for detecting and extracting named entities from narrative
 * text with precise character positions.
 */
...
export const ENTITY_DETECTOR_USER_TEMPLATE = (
  text: string,
