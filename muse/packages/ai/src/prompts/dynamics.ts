...
export const DYNAMICS_QUICK_PROMPT = `Extract character interactions and events from this prose. Focus on who does what to whom.`;

export const DYNAMICS_HOSTILE_FOCUS_PROMPT = `Analyze this passage for conflict. Identify all hostile, threatening, or tension-building interactions between characters.`;

export const DYNAMICS_HIDDEN_FOCUS_PROMPT = `Identify any hidden motives, secret actions, or concealed information in this passage. What is happening beneath the surface?`;
